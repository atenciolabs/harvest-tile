...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredModules, loadDeferredId} = {}) {
    ...
    const dart2wasm = {
      ...
      EJ: x0 => x0.rasterEndMilliseconds,
      F: () => new Error().stack,
      ...
      FI: (a, i) => a.splice(i, 1),
      FJ: x0 => x0.rasterStartMilliseconds,
      ...
      HJ: x0 => x0.canvasKitMaximumSurfaces,
      ...
      WI: (x0,x1) => globalThis.Module_soloud._setPause(x0,x1),
      WJ: x0 => x0.localStorage,
      X: o => [o],
      ...
      XI: (x0,x1) => globalThis.Module_soloud._setRelativePlaySpeed(x0,x1),
      ...
      YG: x0 => x0.buttons,
      YH: () => globalThis.Intl,
      YI: x0 => globalThis.Module_soloud._stop(x0),
      YJ: (x0,x1) => x0.key(x1),
      Z: (o0, o1, o2) => [o0, o1, o2],
      ...
      ZI: x0 => globalThis.Module_soloud._getIsValidVoiceHandle(x0),
      ZJ: x0 => x0.length,
      ...
      aG: x0 => x0.y,
      aH: x0 => x0.index,
      aI: (x0,x1) => globalThis.Module_soloud._setProtectVoice(x0,x1),
      aJ: (x0,x1,x2) => x0.setItem(x1,x2),
      b: (x0,x1,x2) => { x0[x1] = x2 },
      bB: (o, p, v) => o[p] = v,
      bC: o => {
        if (o === null || o === undefined) return 0;
      ...
      cG: x0 => x0.offsetTop,
      cH: x0 => x0.value,
      cI: x0 => globalThis.Module_soloud._getLength(x0),
      cJ: (x0,x1) => x0.share(x1),
      d: (o, p) => o[p],
      dB: (a, i) => a.push(i),
      ...
      dG: x0 => x0.scrollLeft,
      dH: x0 => x0.done,
      dI: x0 => globalThis.Module_soloud._getPosition(x0),
      dJ: x0 => x0.message,
      e: () => globalThis,
      eB: b => !!b,
      ...
      eI: x0 => globalThis.Module_soloud._setDataIsEnded(x0),
      eJ: x0 => x0.name,
      ...
      fH: x0 => x0.iterator,
      fI: x0 => globalThis.Module_soloud._disposeSound(x0),
      ...
      gI: (x0,x1,x2) => globalThis.Module_soloud._addAudioDataStream(x0,x1,x2),
      gJ: (x0,x1) => ({files: x0,text: x1}),
      ...
      pI: x0 => x0.data,
      pJ: () => globalThis.removeSplashFromWeb(),
      ...
      xI: x0 => globalThis.Module_soloud._setGlobalVolume(x0),
      xJ: x0 => x0.assetBase,
      y: (a, i, v) => a[i] = v,
      ...
      yG: x0 => x0.height,
      yH: x0 => x0.disabled,
      yI: (x0,x1) => x0.transferFromImageBitmap(x1),
      yJ: x0 => x0.loader,
